...
res04 = re.search(r"\S", new_s)  # Выводит первый попавшися НЕ пробелильный символ (или несколько символов пордряд если \S\S)
res05 = re.search(r"\w", new_s)  # Выводит первую попашиюся цифру/буквы либо _ (или несколько символов пордряд если \w\w\w)
res06 = re.search(r"\W", new_s)  # Выводит первую попашиюся НЕ цифру/НЕ букву  (или несколько символов пордряд если \W\W\W)
